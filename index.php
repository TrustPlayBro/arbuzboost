...
<head>
    ...
    <title>Главная - ARBUZLEGIT CLIENT</title>
...
<body>
    ...
    <section id="main">
        <div class="page-text">
            ...
            <p class="desc-text anim">Встречайте лучший платный клиент с красивой <br> визуальной составляющией на русском и <br> английском языках!</p>
        ...
        <div class="whyus-text">
            ...
            <div class="container">
                ...
                <div class="wbox">
                    ...
                    <p class="desc">Наш клиент за довольно низкую цену не хуже других платных читов.</p>
                </div>
                <div class="wbox">
                ...
                <div style="cursor: pointer;" target="_blank" onclick="window.location='dsc.gg/arbuzmods'" class="wbox">
    ...
    <section id="showcase"> 
        <div class="video-text">
            ...
            <h1 class="main-text">Видеообзор Vendex Client</h1>
            <p class="desc-text">Это обзор на Платный клиент ARBUZLEGITFT Client в котором <br> демонстрируется часть функционала и часть <br> всего того что на самом деле есть</p>
            <a href="Soon..." class="install-btn"><span><i class='bx bxl-youtube'></i></span> Посмотреть</a>
        </div>
    </section>
    ...
    <section id="inst-client"> 
        <div class="inst-text">
            ...
            <p class="desc">Наилучший Платный чит для новичков с понятным <br>
            ...
            <div class="container">
                <div class="con-box">
                    ...
                    <div class="text">
                        ...
                        <div id="number" data-val="67" class="desc desc-count">0</div>
                    </div>
                </div>
                <div class="con-box">
                    ...
                    <div class="text">
                        ...
                        <div id="number" data-val="146" class="desc desc-count">0</div>
                    </div>
                </div>
                <div class="con-box">
                    ...
                    <div class="text">
                        ...
                        <div id="number" data-val="12" class="desc desc-count">0</div>
                    </div>
                </div>
                <div class="con-box">
                    ...
                    <div class="text">
                        ...
                        <div id="number" data-val="24" class="desc desc-count">0</div>
                    </div>
                </div>
            </div>
        </div>
